...
HD_PWD='C:/Users/chris/BCD_7SegDataFlow/BCD_7SegDataFlow.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_7SegDataFlow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BCD_7SegDataFlow.tcl -notrace
