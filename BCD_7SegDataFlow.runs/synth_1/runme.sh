...
HD_PWD='C:/Users/chris/BCD_7SegDataFlow/BCD_7SegDataFlow.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_7SegDataFlow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCD_7SegDataFlow.tcl
